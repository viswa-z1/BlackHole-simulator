...
function portraitKind(o) {
    ...
    if (t.includes("quasar"))
        return "quasar";
    if (t.includes("ultramassive"))
        return "ultramassive";
    if (t.includes("supermassive"))
        return "supermassive";
    if (t.includes("intermediate"))
        return "intermediate";
    if (t.includes("magnetar"))
        return "magnetar";
    if (t.includes("millisecond"))
        return "millisecond";
    if (t.includes("pulsar"))
        return "pulsar";
    if (t.includes("neutron"))
        return "neutron";
    if (t.includes("binary"))
        return "binary";
    if (t.includes("stellar"))
        return "stellar";
    return "blackhole";
}
